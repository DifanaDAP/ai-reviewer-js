...
1. **Security**: SQL injection, XSS, hardcoded secrets, shell injection.
2. **Performance**: N+1 queries, blocking calls, inefficient patterns.
3. **Code Style**: Naming conventions, anti-patterns, best practices.

## Priority Levels
Prefix your comments with one of the following emojis:
...
## JSON Summary
At the very end of your response, strictly provide a JSON summary of the issues found inside <json> tags:
<json>
{
...
<json>
{
  "security": [],
  "performance": [],
  "style": ["Syntax error in add function"]
}
</json>
